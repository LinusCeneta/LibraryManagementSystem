...
<body>
    <div class="container">
        <h2><i class="fas fa-sync-alt"></i> Renew Loan</h2>
        ...
        <div class="form-container">
            <form action="RenewLoanServlet" method="post">
                <div class="form-group">
                    <label for="loanId"><i class="fas fa-id-card"></i> Loan ID</label>
                    <input type="text" id="loanId" name="loanId" required>
                </div>

                <div class="action-buttons">
                    <button type="submit" class="submit-btn">
                        <i class="fas fa-sync-alt"></i> Renew Loan
                    </button>
