...
<form action="ReceivingServlet" method="post">
    <!-- Existing fields -->
    ...
    <table>
        ...
        <tr>
            ...
            <td>${item.quantity}</td>
            <td><input type="number" name="receivedQty_${item.id}" value="${item.quantity}"></td>
            <td><input type="number" name="damagedQty_${item.id}" value="0"></td>
            <td><select name="condition_${item.id}">...</select></td>
        </tr>
        </c:forEach>
    </table>
    
    <input type="submit" value="Record Receipt">
</form>