...
<form action="InventoryAdjustmentServlet" method="post">
    Copy ID: <input type="number" name="copyId" required /><br/>
    Adjustment Type:
    ...
    Adjustment Date: <input type="date" name="adjustmentDate" required /><br/>
    User: <input type="text" name="user" required /><br/>
    <input type="submit" value="Record Adjustment" />
</form>
