...
@WebServlet("/purchase-request-delete")
public class PurchaseRequestDeleteServlet extends HttpServlet {
    private static final Logger logger = Logger.getLogger(PurchaseRequestDeleteServlet.class.getName());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getSession().setAttribute("successMessage", "Request deleted successfully!");
